...
describe(`Quadrant View Navigation - SEM Outputs Partial Prioritization - Test 1`, () => {
    ...
    it(`Verify that the Quadrant view updates to show Header is not displayed`, async function () {
