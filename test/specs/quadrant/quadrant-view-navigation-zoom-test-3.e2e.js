...
describe(`Quadrant View Navigation - Zoom - Test 3`, () => {
    ...
    it(`Icon should be an arrow before it is expanded (bottom-left)`, async function () {
        let quad = await brandPositioningPage.getQuadrant(`bottom-left`);
        await quad.moveTo();
        let baseQuad = await brandPositioningPage.getQuadrantExpander('bottom-left');

        assert.equal(baseQuad.icon, "expand", "Icon should be an expanding arrow, but is not")
    })

    it(`Verify that the Quadrant zooms in and fills the space (bottom-left)`, async function () {
        let baseQuad = await brandPositioningPage.getQuadrantExpander('bottom-left');
    ...
    it(`Icon should be an "X" after it is expanded (bottom-left)`, async function () {
    ...
    it(`Verify that the view pans to that new quadrant when the Top Right quadrant is clicked (bottom-left to top-left)`, async function (){
        let quad = await brandPositioningPage.getQuadrant(`top-left`);
        await quad.moveTo();
    ...
    it(`Verify that the view pans to that new quadrant when the Top Right quadrant is clicked (bottom-left to top-right)`, async function (){
    ...
    it(`Verify that the view pans to that new quadrant when the Top Right quadrant is clicked (bottom-left to bottom-right)`, async function (){
    ...
    it(`Verify that the view is zoomed back out to the normal 2x2 Quadrant View (bottom-left)`, async function (){
        let baseQuad = await brandPositioningPage.getQuadrantExpander('bottom-left');
        await baseQuad.el.click()
